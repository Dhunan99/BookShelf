    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AuthorID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.authors')),
                ('LanguageID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.languages')),
            ],
        ),
    ]
